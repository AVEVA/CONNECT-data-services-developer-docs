...
| 6       | `Id`="md_id"<br/> `Name`="**m6**"<br/>  `Value`=10    | `Id`="md_id"<br/> `Name`="anotherName"<br/>  `Value`="1234" | `Id`="md_id"<br/> `Name`="**m6**"<br/>  `Value`=10        | The `Metadata` value with `Id`= "md_id" has a different value for the `Name` property and `Name` on the asset is not null. Therefore, the default shape's `Metadata` value takes the  asset type's `Metadata` value. |
