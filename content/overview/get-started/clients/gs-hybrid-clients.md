...
1. Enter the URLs in the **Allowed Redirect URL(s)** text box, then click **+** to add it to the list.  
   ...
   The application specifies one of the URLs in this list during authentication, and the AVEVA™ Data Hub returns the results of the authentication to this URL.
