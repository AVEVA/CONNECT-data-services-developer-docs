...
easily obtain needed information.
   ...
   - [Identity](xref:identityOverview)
     - [IdentityProvider Calls](xref:identityIdentityProvider)
     - [Tenant Calls](xref:identityTenant)
     - [Client Calls](xref:identityClient)
     - [User Calls](xref:identityUser)
     - [Invitation Calls](xref:identityInvitation)
