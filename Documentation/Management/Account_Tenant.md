...
APIs to manage an OCS Customer Tenant Account. Note that unlinke Namespaces, Tenants are not scoped to a region. Account level information, such as Users and Clients, are stored in all supported regions.
