...
In many instances, you will have multiple assets of the same type. In this situation, an asset type can be used to create multiple similar assets. If you make a change to an asset type, it is reflected in all assets that are derived from that asset type.
