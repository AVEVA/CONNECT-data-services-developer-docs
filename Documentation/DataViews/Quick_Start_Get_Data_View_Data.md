...
### Action
Use the hyperlink in the Link header marked as next to request the next page.
```text
GET /api/v1-preview/Tenants/{tenantId}/Namespaces/{namespaceId}/DataViews/quickstart/Data/Interpolated
...
### Action
Use the hyperlink in the Link header marked as first to request the first page.
