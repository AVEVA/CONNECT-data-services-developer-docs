...
<p sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="36" sourceendlinenumber="36"><code>api/v1-preview/Tenants/{tenantId}/Namespaces/{namespaceId}/Streams/{streamId}/Data</code></p>
...
<h2 id="sdsstreamview-and-reading-data" sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="94" sourceendlinenumber="95">SdsStreamView and reading data</h2>
<p sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="97" sourceendlinenumber="97">All reads support specifying an SdsStreamView identifier in the query string to shape the results of the read:</p>
<p sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="99" sourceendlinenumber="99"><code>streamViewId={streamViewId}</code></p>
<p sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="101" sourceendlinenumber="101">Working with stream views is covered in detail in the <a class="xref" href="SDS_Views.html" data-raw-source="[Stream Views](xref:sdsViews)" sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="101" sourceendlinenumber="101">Stream Views</a> section.</p>
<p sourcefile="Documentation/SequentialDataStore/Reading_Data.md" sourcestartlinenumber="103" sourceendlinenumber="105">When data is requested with an SdsStreamView the read characteristics defined by the <em>target type</em> of the SdsStreamView 
