...
| Property | Type | Description | 
 | --- | --- | ---  | 
| Id | string | Gets or sets GUID for this Tenant. Generated by the server upon Creation. Same as AAD Id. | 
| CompanyName | string | Gets or sets Company Name of this Tenant. | 
| State | TenantProvisioningState | Gets or sets current Tenant Provisioning State for this Tenant. | 
| Created | DateTime | Gets or sets date and time this Tenant was added to OCS. | 
| LastUpdated | DateTime | Gets or sets date this Tenant was last updated. | 
| Alias | string | Gets or sets specifies a unique alias for this Tenant. | 
| Features | [FeatureState] | Gets or sets list of Feature States for this Tenant. Returned during get calls. | 
