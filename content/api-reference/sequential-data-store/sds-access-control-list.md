...
|---|---|---|---|
|If-Match-Match|string|false|<span style="background-color:red;color:white">ERROR: Parameter "ifMatch" could not be found in external reference file</span>|
...
|Header|Type|Required|Description|
|---|---|---|---|
|If-Match-Match|string|false|The entity tag header from a previous read of the ACL. If provided, the ACL will not be patched unless the current ETag of the ACL, on the server, matches the value passed into the If-Match header.|
