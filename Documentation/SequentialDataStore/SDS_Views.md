...
To see how SdsStreamView impacts a stream, you can apply a stream view to any read or GET operation. For more information, see [Reading with SdsStreamViews](xref:sdsReadingData#reading-with-sdsstreamviews).
