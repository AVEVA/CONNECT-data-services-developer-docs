...
## Specify the shape
Set the [`DataViewShape`](xref:DefineaDataViewRecommendedWorkflow#data-view-properties) property to a value of the [`DataViewShape` enumeration](xref:DefineaDataViewRecommendedWorkflow#dataviewshape-enumeration), either `DataViewShape.Standard` (default) or `DataViewShape.Narrow`.
