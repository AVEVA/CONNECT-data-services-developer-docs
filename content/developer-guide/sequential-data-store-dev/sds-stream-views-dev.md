...
| CreatedDate       | DateTime               | No    | No |  Timestamp in ISO 8601 extended format and UTC time standard at which the SdsStreamView was created. Cannot be modified by users. |
| ModifiedDate      | DateTime               | No   | No |  Timestamp in ISO 8601 extended format and UTC time standard at which the SdsStreamView was last modified. Cannot be modified by users. |
