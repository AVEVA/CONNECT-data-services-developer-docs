...
## Example
The example uses the following data view and the streams from the [Stream examples](xref:DataViewsStreamExamples). Note that the field sets and the grouping fields arrays are empty:
```json
{
