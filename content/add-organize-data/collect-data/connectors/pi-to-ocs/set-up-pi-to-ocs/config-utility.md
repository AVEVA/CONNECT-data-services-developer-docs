...
It may take a few minutes for a PI System to register with AVEVA Data Hub. The table below lists the various states that may appear under the **Agent Status** field in the PI to Data Hub Configuration Utility.
