...
<br/>Optional parameter consisting of stream reference names you are interested in in the format of `stream={streamReferenceName}`. Multiple stream references can be requested by joining with &amp;. By default, all data calls return data for all stream references.<br/><br/>
...
`[optional] array stream`
<br/>Optional parameter consisting of stream reference names you are interested in in the format of `stream={streamReferenceName}`. Multiple stream references can be requested by joining with &amp;. By default, all data calls return data for all stream references.<br/><br/>`[optional] any boundaryType`
...
`[optional] array stream`
<br/>Optional parameter consisting of stream reference names you are interested in in the format of `stream={streamReferenceName}`. Multiple stream references can be requested by joining with &amp;. By default, all data calls return data for all stream references.<br/><br/>`[optional] integer count`
