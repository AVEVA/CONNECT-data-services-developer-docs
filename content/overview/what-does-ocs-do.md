...
Identity is the authentication factor used to verify a user or client that requests access to OCS. Data Hub identity services provide the following functions: 
...
![](images/how-does-ocs-work/assets-example.png)
