...
```text 
GET /api/v1/Account/{accountId}/sds/{serviceInstanceId}/Streams/{streamId}/Data
...
## `List Values (Tenants path)`

<a id="opIdStreamData_List Values (Tenants path)"></a>
...
## `List Sampled Values (Account path)`

<a id="opIdStreamData_List Sampled Values (Account path)"></a>
...
```text 
GET /api/v1/Account/{accountId}/sds/{serviceInstanceId}/Streams/{streamId}/Data/Sampled
...
## `List Sampled Values (Tenants path)`

<a id="opIdStreamData_List Sampled Values (Tenants path)"></a>
