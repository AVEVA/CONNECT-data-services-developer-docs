...
The `Trend` page opens with each selected stream added to the trend session. For more information on working with trend sessions, see <xref:TrendUserInterface>.