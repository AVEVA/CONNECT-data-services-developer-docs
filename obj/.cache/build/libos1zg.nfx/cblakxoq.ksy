...
<pre sourcefile="Documentation/OSIsoft_Cloud_Services.md" sourcestartlinenumber="38" sourceendlinenumber="40"><code class="lang-text">    api/v{version}/Tenants/{tenantId}/Namespaces/{namespaceId}/...  
