...
| TenantId | string | Gets or sets unique identifier of Tenant for this Role, if this is a Account Role, null otherwise. **Note:** TenantId will be removed in the next version. Please remove references to it. | 
