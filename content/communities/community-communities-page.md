...
| **Sharing Status** | Indicates whether on or more tenant in the community is sharing a data stream. Statuses include: <ul><p><li><img src="../_icons/custom/check-circle.svg"/> <strong>Sharing Active</strong>: The community currently allows its members to view shared data streams in <code>Sequential Data Store</code>.</p></li><li><p><img src="../_icons/custom/pause-circle.svg"/> <strong>Sharing Paused</strong>: The community currently is paused for sharing. <!-- TODO: Update --></p></li></ul> |
